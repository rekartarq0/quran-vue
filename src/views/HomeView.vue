...
<template>
  ...
  >
  <i class="fas fa-truck-loading w-10 animate-spin text-thirty "></i>
  </div>
  <div
    v-show="loading == false"
    class="flex flex-col gap-y-6 items-center p-5 w-full"
  >
    <div
    ...
    >
      <div v-for="surah in filteredQuran" :key="surah">
        ...
        >
          ...
          <div
           :title="'سورەتی ژمارە '+ surah.index"
           class="flex flex-row items-center gap-x-2">
            ...
            <div class="flex flex-col items-start">
              <span  :title="'سورەتی '+ surah.name" class="font-bold text-md">{{ surah.name }}</span>
              <span
               :title="'سورەتی '+surah.type"
                :class="
                  isIndex == surah.index
              ...
              >
                ...
                <span
                :title="'ژمارەی ئایەت '+ surah.versesNumber"
